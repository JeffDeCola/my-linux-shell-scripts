#!/bin/sh
# my-linux-shell-scripts readme-github-pages.sh
...
echo "The goal is to git clone /my-linux-shell-scripts to /my-linux-shell-scripts-updated"
...
echo "   /my-linux-shell-scripts"
echo "   /my-linux-shell-scripts-updated (created in task-build-push.yml task file)"
echo " "
...
echo "git clone my-linux-shell-scripts to my-linux-shell-scripts-updated"
git clone my-linux-shell-scripts my-linux-shell-scripts-updated
echo " "

echo "cd my-linux-shell-scripts-updated"
cd my-linux-shell-scripts-updated
echo " "
...
echo "    sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/my-linux-shell-scripts\/master\/svgs\//g' temp-README.md"
sed -i 's/svgs\//https:\/\/raw.githubusercontent.com\/JeffDeCola\/my-linux-shell-scripts\/master\/svgs\//g' temp-README.md
echo " "
